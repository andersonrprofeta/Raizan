    ...
    <div className="space-y-10 animate-in fade-in slide-in-from-right-4 duration-300">
      ...
      <section className="space-y-5">
        <h2 className="text-lg font-bold text-zinc-100 flex items-center gap-2 border-b border-zinc-800 pb-2">
          <Package className="text-purple-500" size={20} /> Dados Gerais
        </h2>
        
        <div className="grid grid-cols-1 md:grid-cols-12 gap-5">
          {/* Tipo do Produto */}
          <div className="space-y-2 md:col-span-4 lg:col-span-3">
            <label className="text-sm font-medium text-zinc-300">Tipo do Produto</label>
            <select 
              value={produto.basico.tipo_produto}
              onChange={(e) => atualizarCampo('basico', 'tipo_produto', e.target.value)}
              className="w-full bg-zinc-950 border border-zinc-800 rounded-xl p-3.5 text-sm text-zinc-200 focus:border-purple-500 focus:ring-1 focus:ring-purple-500 outline-none transition-all cursor-pointer"
            >
          ...
          <div className="space-y-2 md:col-span-8">
            ...
            />
            <p className="text-[11px] text-zinc-500">Necessário para emissão de Nota Fiscal</p>
          </div>

          {/* GTIN */}
          <div className="space-y-2 md:col-span-4">
            <label className="text-sm font-medium text-zinc-300">Código de barras (GTIN)</label>
            <input 
              ...
              className="w-full bg-zinc-950 border border-zinc-800 rounded-xl p-3.5 text-sm text-zinc-200 focus:border-purple-500 outline-none transition-all"
            />
            <p className="text-[11px] text-zinc-500">Global Trade Item Number</p>
          </div>

          {/* Origem ICMS */}
          <div className="space-y-2 md:col-span-8">
            <label className="text-sm font-medium text-zinc-300">Origem do produto conforme ICMS</label>
            <select 
              value={produto.basico.origem}
              onChange={(e) => atualizarCampo('basico', 'origem', e.target.value)}
              className="w-full bg-zinc-950 border border-zinc-800 rounded-xl p-3.5 text-sm text-zinc-200 focus:border-purple-500 outline-none transition-all cursor-pointer"
            >
          ...
          <div className="space-y-2 md:col-span-2">
            <label className="text-sm font-medium text-zinc-300">Unid. Medida</label>
            <input 
              type="text" placeholder="UN"
              value={produto.basico.unidade}
              onChange={(e) => atualizarCampo('basico', 'unidade', e.target.value.toUpperCase())}
              className="w-full bg-zinc-950 border border-zinc-800 rounded-xl p-3.5 text-sm text-zinc-200 focus:border-purple-500 outline-none transition-all uppercase"
            />
          </div>

          {/* NCM */}
          <div className="space-y-2 md:col-span-2">
            <label className="text-sm font-medium text-zinc-300">NCM</label>
            <input 
          ...
          {/* SKU */}
          <div className="space-y-2 md:col-span-4">
            <label className="text-sm font-medium text-zinc-300">Código (SKU)</label>
            <input 
              ...
              className="w-full bg-zinc-950 border border-zinc-800 rounded-xl p-3.5 text-sm text-zinc-200 focus:border-purple-500 outline-none transition-all"
            />
            <p className="text-[11px] text-zinc-500">Opcional</p>
          </div>

          {/* CEST */}
          <div className="space-y-2 md:col-span-4">
            <label className="text-sm font-medium text-zinc-300">Código CEST</label>
            <input 
          ...
          <div className="space-y-2 md:col-span-4 relative">
            <label className="text-sm font-bold text-purple-400">Preço de venda (R$)</label>
            <input 
              type="number" step="0.01" placeholder="0,00"
              value={produto.precos.venda}
              onChange={(e) => atualizarCampo('precos', 'venda', e.target.value)}
              className="w-full bg-purple-500/10 border border-purple-500/50 rounded-xl p-3.5 text-lg text-purple-400 font-black focus:border-purple-400 outline-none transition-all shadow-[0_0_15px_rgba(168,85,247,0.1)]"
            />
          </div>

          <div className="space-y-2 md:col-span-4">
            <label className="text-sm font-medium text-zinc-300">Preço promocional (R$)</label>
            <input 
              type="number" step="0.01" placeholder="0,00"
              value={produto.precos.promocional}
              onChange={(e) => atualizarCampo('precos', 'promocional', e.target.value)}
              className="w-full bg-zinc-950 border border-zinc-800 rounded-xl p-3.5 text-base text-zinc-200 focus:border-purple-500 outline-none transition-all"
            />
          </div>
      ...
      <section className="space-y-5">
        <h2 className="text-lg font-bold text-zinc-100 flex items-center gap-2 border-b border-zinc-800 pb-2">
          <Box className="text-purple-500" size={20} /> Dimensões e peso
        </h2>
        <p className="text-xs text-zinc-500 -mt-2">Indispensável para cálculo de frete em vendas online.</p>
        
        <div className="grid grid-cols-1 md:grid-cols-4 gap-5">
            {/* Pesos */}
            <div className="space-y-2 md:col-span-2 relative">
              <label className="text-sm font-medium text-zinc-300">Peso Líquido</label>
              <div className="relative">
                <input 
                  type="number" step="0.01" placeholder="0,00"
                  value={produto.dimensoes.peso_liquido}
                  onChange={(e) => atualizarCampo('dimensoes', 'peso_liquido', e.target.value)}
                  className="w-full bg-zinc-950 border border-zinc-800 rounded-xl p-3.5 pr-12 text-sm text-zinc-200 focus:border-purple-500 outline-none transition-all"
                />
                <span className="absolute right-3 top-1/2 -translate-y-1/2 text-xs font-bold text-zinc-500 bg-zinc-900 px-2 py-1 rounded">kg</span>
              </div>
            </div>

            <div className="space-y-2 md:col-span-2 relative">
              <label className="text-sm font-medium text-zinc-300">Peso Bruto</label>
              <div className="relative">
                <input 
                  type="number" step="0.01" placeholder="0,00"
            ...
            {/* Embalagens */}
            <div className="space-y-2 md:col-span-2">
              <label className="text-sm font-medium text-zinc-300">Tipo da embalagem</label>
              <select 
            ...
            <div className="space-y-2 md:col-span-2">
              <label className="text-sm font-medium text-zinc-300">Embalagem</label>
              <select 
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium text-zinc-300">Largura</label>
              <div className="relative">
                <input 
                  ...
                  className="w-full bg-zinc-950 border border-zinc-800 rounded-xl p-3.5 pr-12 text-sm text-zinc-200 focus:border-purple-500 outline-none transition-all"
                />
                <span className="absolute right-3 top-1/2 -translate-y-1/2 text-xs font-bold text-zinc-500 bg-zinc-900 px-2 py-1 rounded">cm</span>
              </div>
            </div>

            <div className="space-y-2">
              <label className="text-sm font-medium text-zinc-300">Altura</label>
              <div className="relative">
                <input 
                  type="number" step="0.1" placeholder="0,0"
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium text-zinc-300">Comprimento</label>
              <div className="relative">
                <input 
                  type="number" step="0.1" placeholder="0,0"
      ...
      <section className="space-y-5">
        <h2 className="text-lg font-bold text-zinc-100 flex items-center gap-2 border-b border-zinc-800 pb-2">
          <Archive className="text-purple-500" size={20} /> Estoque
        </h2>
        
        <div className="grid grid-cols-1 md:grid-cols-4 gap-5">
            
            <div className="space-y-2">
              <label className="text-sm font-medium text-zinc-300">Controlar estoque</label>
              <select 
              ...
              <p className="text-[11px] text-zinc-500">Acompanhamento automático</p>
            </div>

            <div className="space-y-2">
              <label className="text-sm font-medium text-zinc-300">Estoque inicial</label>
              <div className="relative">
                <input 
                  ...
                  className="w-full bg-zinc-950 border border-zinc-800 rounded-xl p-3.5 pr-12 text-sm text-zinc-200 focus:border-purple-500 outline-none transition-all"
                />
                <span className="absolute right-3 top-1/2 -translate-y-1/2 text-xs font-bold text-zinc-500 bg-zinc-900 px-2 py-1 rounded">un</span>
              </div>
            </div>
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium text-zinc-300">Estoque máximo</label>
              <div className="relative">
                <input 
                  type="number" placeholder="0"
            ...
            <div className="space-y-2 md:col-span-2">
              ...
              <input 
                ...
                className="w-full bg-zinc-950 border border-zinc-800 rounded-xl p-3.5 text-sm text-zinc-200 focus:border-purple-500 outline-none transition-all"
              />
              <p className="text-[11px] text-zinc-500">Localização física no estoque</p>
            </div>

            <div className="space-y-2 md:col-span-2">
              <label className="text-sm font-medium text-zinc-300">Dias para preparação</label>
              <input 
                type="number" placeholder="0"
                ...
                className="w-full bg-zinc-950 border border-zinc-800 rounded-xl p-3.5 text-sm text-zinc-200 focus:border-purple-500 outline-none transition-all"
              />
              <p className="text-[11px] text-zinc-500">Tempo adicional somado ao frete</p>
            </div>
