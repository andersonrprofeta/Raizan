...
function ModalDetalhes({ pedido, onClose, onPagarAgora }) {
  ...
  // 🟢 NOVA FUNÇÃO: Dispara a solicitação de documentos pro servidor
  const handleSolicitarDocs = async () => {
    ...
    try {
      ...
      if (data.success) {
        ...
        onClose(); // Fecha o modal para atualizar a tela
      } else {
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar p-6 space-y-6">
          ...
          <div className="flex flex-col">
            ...
            <div className="bg-zinc-900/30 border border-zinc-800 rounded-xl overflow-hidden flex flex-col">
              ...
              {/* ========================================== */}
              <div className="p-4 bg-zinc-950 border-t border-zinc-800 shrink-0 flex flex-col gap-3">
                
                {/* 1. BOTÃO PAGAR AGORA (Mantido intacto!) */}
                ...
                {getMeta('link_xml_boleto') !== "Não informado" ? (
                  ...
                  <div className="w-full bg-amber-500/10 border border-amber-500/30 text-amber-400 py-3.5 rounded-xl font-bold flex items-center justify-center gap-2 cursor-not-allowed">
                  ...
                  <button onClick={handleSolicitarDocs} className="w-full bg-zinc-800 hover:bg-zinc-700 text-white py-3.5 rounded-xl font-bold transition-all flex items-center justify-center gap-2 border border-zinc-700">
